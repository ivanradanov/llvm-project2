...
// CHECK:           %[[VAL_3:.*]] = llvm.alloca %[[VAL_2]] x !llvm.struct<"foo", (i32, f64, array<10 x i32>, i8)> {alignment = 8 : i64} : (i32) -> !llvm.ptr
// CHECK:           %[[VAL_4:.*]] = llvm.getelementptr inbounds %[[VAL_3]]{{\[}}%[[VAL_0]], 2, %[[VAL_1]]] : (!llvm.ptr, i32, i32) -> !llvm.ptr, !llvm.struct<"foo", (i32, f64, array<10 x i32>, i8)>
// CHECK:           %[[VAL_5:.*]] = llvm.load %[[VAL_4]] : !llvm.ptr -> i32
// CHECK:           llvm.return %[[VAL_5]] : i32
// CHECK:         }
...
// CHECK:           %[[VAL_2:.*]] = llvm.mlir.constant(2 : i32) : i32
// CHECK:           %[[VAL_3:.*]] = llvm.alloca %[[VAL_2]] x !llvm.struct<"foo", (i32, f64, array<10 x i32>, i8)> {alignment = 8 : i64} : (i32) -> !llvm.ptr
// CHECK:           %[[VAL_4:.*]] = llvm.getelementptr inbounds %[[VAL_3]]{{\[}}%[[VAL_0]]] : (!llvm.ptr, i32) -> !llvm.ptr, !llvm.struct<"foo", (i32, f64, array<10 x i32>, i8)>
// CHECK:           %[[VAL_5:.*]] = llvm.getelementptr inbounds %[[VAL_4]][0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"foo", (i32, f64, array<10 x i32>, i8)>
// CHECK:           %[[VAL_6:.*]] = llvm.getelementptr inbounds %[[VAL_5]]{{\[}}%[[VAL_1]]] : (!llvm.ptr, i32) -> !llvm.ptr, i32
// CHECK:           %[[VAL_7:.*]] = llvm.load %[[VAL_6]] : !llvm.ptr -> i32
// CHECK:           llvm.return %[[VAL_7]] : i32
// CHECK:         }
llvm.func @multi_level_direct_two_applications(%i1 : i32, %i2 : i32) -> i32 {
  %0 = llvm.mlir.constant(2 : i32) : i32
  %1 = llvm.alloca %0 x !llvm.struct<"foo", (i32, f64, array<10 x i32>, i8)> {alignment = 8 : i64} : (i32) -> !llvm.ptr
...
// CHECK:           %[[VAL_3:.*]] = llvm.alloca %[[VAL_2]] x !llvm.struct<"foo", (i32, f64, array<10 x i32>, i8)> {alignment = 8 : i64} : (i32) -> !llvm.ptr
// CHECK:           %[[VAL_4:.*]] = llvm.getelementptr inbounds %[[VAL_3]]{{\[}}%[[VAL_0]]] : (!llvm.ptr, i32) -> !llvm.ptr, !llvm.struct<"foo", (i32, f64, array<10 x i32>, i8)>
// CHECK:           %[[VAL_5:.*]] = llvm.getelementptr inbounds %[[VAL_4]]{{\[}}%[[VAL_0]], 2] : (!llvm.ptr, i32) -> !llvm.ptr, !llvm.struct<"foo", (i32, f64, array<10 x i32>, i8)>
// CHECK:           %[[VAL_6:.*]] = llvm.getelementptr inbounds %[[VAL_5]]{{\[}}%[[VAL_0]]] : (!llvm.ptr, i32) -> !llvm.ptr, i32
// CHECK:           %[[VAL_7:.*]] = llvm.load %[[VAL_6]] : !llvm.ptr -> i32
// CHECK:           llvm.return %[[VAL_7]] : i32
// CHECK:         }
llvm.func @multi_level_direct_two_applications(%i1 : i32, %i2 : i32) -> i32 {
...
// CHECK:             %[[VAL_5:.*]] = llvm.bitcast %[[VAL_4]] : vector<4xi8> to i32
// CHECK:             affine.for %[[VAL_6:.*]] = 5 to 100 {
// CHECK:               %[[VAL_7:.*]] = arith.index_cast %[[VAL_6]] : index to i32
// CHECK:               %[[VAL_8:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_5]]] : (!llvm.ptr, i32) -> !llvm.ptr, i32
...
// CHECK:             %[[VAL_8:.*]] = affine.vector_load %[[VAL_3]][0] : memref<?xi8>, vector<4xi8>
// CHECK:             %[[VAL_9:.*]] = llvm.bitcast %[[VAL_8]] : vector<4xi8> to i32
// CHECK:             affine.for %[[VAL_10:.*]] = 5 to 100 {
// CHECK:               %[[VAL_11:.*]] = arith.index_cast %[[VAL_7]] : index to i32
// CHECK:               %[[VAL_12:.*]] = llvm.getelementptr %[[VAL_1]]{{\[}}%[[VAL_11]]] : (!llvm.ptr, i32) -> !llvm.ptr, i32
