...
// CHECK:             %[[VAL_8:.*]] = llvm.getelementptr inbounds %[[VAL_6]]{{\[}}%[[VAL_0]], 2, %[[VAL_1]]] : (!llvm.ptr, i32, i32) -> !llvm.ptr, !llvm.struct<"foo", (i32, f64, array<10 x i32>, i8)>
// CHECK:             %[[VAL_9:.*]] = affine.vector_load %[[VAL_7]][((symbol(%[[VAL_3]]) * 8 + 1) * 2 + 2) * 4 + symbol(%[[VAL_2]]) * 4] : memref<?xi8>, vector<4xi8>
...
// CHECK:             %[[VAL_9:.*]] = llvm.getelementptr inbounds %[[VAL_8]][0, 2] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<"foo", (i32, f64, array<10 x i32>, i8)>
// CHECK:             %[[VAL_10:.*]] = llvm.getelementptr inbounds %[[VAL_9]]{{\[}}%[[VAL_1]]] : (!llvm.ptr, i32) -> !llvm.ptr, i32
// CHECK:             %[[VAL_11:.*]] = affine.vector_load %[[VAL_7]][symbol(%[[VAL_2]]) * 64 + symbol(%[[VAL_3]]) * 4 + 16] : memref<?xi8>, vector<4xi8>
...
// CHECK:             %[[VAL_8:.*]] = llvm.getelementptr inbounds %[[VAL_7]]{{\[}}%[[VAL_0]], 2] : (!llvm.ptr, i32) -> !llvm.ptr, !llvm.struct<"foo", (i32, f64, array<10 x i32>, i8)>
// CHECK:             %[[VAL_9:.*]] = llvm.getelementptr inbounds %[[VAL_8]]{{\[}}%[[VAL_0]]] : (!llvm.ptr, i32) -> !llvm.ptr, i32
// CHECK:             %[[VAL_10:.*]] = affine.vector_load %[[VAL_6]][symbol(%[[VAL_2]]) * 64 + ((symbol(%[[VAL_2]]) * 8 + 1) * 2 + 2) * 4 + symbol(%[[VAL_2]]) * 4] : memref<?xi8>, vector<4xi8>
// CHECK:             %[[VAL_11:.*]] = llvm.bitcast %[[VAL_10]] : vector<4xi8> to i32
// CHECK:             affine.yield %[[VAL_11]] : i32
// CHECK:           }) : () -> i32
...
// CHECK:                 %[[VAL_16:.*]] = affine.vector_load %[[VAL_4]][symbol(%[[VAL_9]]) * 4] : memref<?xi8>, vector<4xi8>
// CHECK:                 %[[VAL_17:.*]] = llvm.bitcast %[[VAL_16]] : vector<4xi8> to i32
// CHECK:                 %[[VAL_18:.*]] = llvm.bitcast %[[VAL_17]] : i32 to vector<4xi8>
// CHECK:                 affine.vector_store %[[VAL_18]], %[[VAL_5]][symbol(%[[VAL_9]]) * 4] : memref<?xi8>, vector<4xi8>
// CHECK:               }
// CHECK:               affine.yield
// CHECK:             }) : () -> ()
// CHECK:           }
