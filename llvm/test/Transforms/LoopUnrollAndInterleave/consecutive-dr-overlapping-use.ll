...
; CHECK:       if.end:
; CHECK-NEXT:    [[CALL8:%.*]] = tail call noundef zeroext i1 @_Z5test2i(i32 noundef [[CONV6]]) #[[ATTR8]]
; CHECK-NEXT:    [[CALL8_COARSENED_1:%.*]] = tail call noundef zeroext i1 @_Z5test2i(i32 noundef [[CONV6_COARSENED_1]]) #[[ATTR8]]
...
; CHECK-NEXT:    tail call void @_Z4use1i(i32 noundef [[B_0_DRS_1_REG2MEM_0]]) #[[ATTR8]]
...
; CHECK-NEXT:    [[CALL8_EPILOGUE]] = tail call noundef zeroext i1 @_Z5test2i(i32 noundef [[CONV6_EPILOGUE]]) #[[ATTR8]]
...
; DRCHECK-NEXT:    [[CALL8:%.*]] = tail call noundef zeroext i1 @_Z5test2i(i32 noundef [[CONV6]]) #[[ATTR8]]
; DRCHECK-NEXT:    [[CALL8_COARSENED_1:%.*]] = tail call noundef zeroext i1 @_Z5test2i(i32 noundef [[CONV6_COARSENED_1]]) #[[ATTR8]]
; DRCHECK-NEXT:    [[TMP13:%.*]] = icmp eq i1 [[CALL8_COARSENED_1]], [[CALL8]]
; DRCHECK-NEXT:    [[TMP14:%.*]] = and i1 [[TMP13]], true
; DRCHECK-NEXT:    br i1 [[TMP14]], label [[IF_END_DIVERGENT_ENTRY:%.*]], label [[IF_END_DIVERGENT_ENTRY_DRS_1_INTRO_0:%.*]]
...
; DRCHECK-NEXT:    tail call void @_Z4use1i(i32 noundef [[B_0_DRS_1_REG2MEM_0]]) #[[ATTR8]]
...
; DRCHECK-NEXT:    [[CALL8_EPILOGUE]] = tail call noundef zeroext i1 @_Z5test2i(i32 noundef [[CONV6_EPILOGUE]]) #[[ATTR8]]
