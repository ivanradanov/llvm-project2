...
; DRCHECK-NEXT:    [[TMP10:%.*]] = icmp eq i1 [[CMP6_COARSENED_1]], [[CMP6]]
...
; DRCHECK-NEXT:    br i1 [[TMP11]], label [[IF_THEN_DIVERGENT_ENTRY:%.*]], label [[IF_THEN_DIVERGENT_ENTRY_DRS_2_INTRO_0:%.*]]
...
; DRCHECK-NEXT:    br i1 [[TMP12]], label [[IF_ELSE9_DIVERGENT_ENTRY:%.*]], label [[IF_ELSE9_DIVERGENT_ENTRY_DRS_1_INTRO_0:%.*]]
