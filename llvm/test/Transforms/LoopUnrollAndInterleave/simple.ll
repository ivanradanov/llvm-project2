...
; CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[ARRAYIDX]], align 4, !tbaa [[TBAA16]]
; CHECK-NEXT:    [[ADD6:%.*]] = add nsw i32 [[TMP3]], 100000
...
; CHECK-NEXT:    br i1 [[CMP4]], label [[OMP_INNER_FOR_BODY]], label [[OMP_LOOP_EXIT_LOOPEXIT:%.*]]
