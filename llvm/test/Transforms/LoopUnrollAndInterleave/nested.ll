...
; CHECK-DAG:    [[DR_COARSENED_IDENT_0:%.*]] = phi i32 [ 0, [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_INTRO_0]] ], [ 1, [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_INTRO_1]] ]
; CHECK-DAG:    [[CONV6_DRS_REG2MEM_0:%.*]] = phi i32 [ [[CONV6]], [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_INTRO_0]] ], [ [[CONV6_COARSENED_1]], [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_INTRO_1]] ]
; CHECK-DAG:    [[CALL_DRS_REG2MEM_0:%.*]] = phi i1 [ [[CALL]], [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_INTRO_0]] ], [ [[CALL_COARSENED_1]], [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_INTRO_1]] ]
...
; DRCHECK-NEXT:    [[CALL8_DRS_REG2MEM_0:%.*]] = phi i1 [ [[CALL8]], [[IF_THEN_DIVERGENT_ENTRY_DRS_INTRO_0]] ], [ [[FORWARD_PHI:%.*]], [[IF_THEN_DIVERGENT_ENTRY_DRS_INTRO_1]] ], [ [[CALL8_DRS:%.*]], [[IF_THEN_DIVERGENT_ENTRY_DRS_INTRO_NESTED]] ]
; DRCHECK-NEXT:    [[FORWARD_PHI]] = phi i1 [ [[CALL8_COARSENED_1]], [[IF_THEN_DIVERGENT_ENTRY_DRS_INTRO_0]] ], [ [[FORWARD_PHI]], [[IF_THEN_DIVERGENT_ENTRY_DRS_INTRO_1]] ], [ undef, [[IF_THEN_DIVERGENT_ENTRY_DRS_INTRO_NESTED]] ]
...
; DRCHECK-DAG:    [[DR_COARSENED_IDENT_5]] = phi i32 [ 1, [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_INTRO_1]] ], [ 0, [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_INTRO_0]] ]
; DRCHECK-DAG:    [[CONV6_DRS_REG2MEM_0:%.*]] = phi i32 [ [[CONV6_COARSENED_1]], [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_INTRO_1]] ], [ [[CONV6]], [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_INTRO_0]] ]
; DRCHECK-DAG:    [[CALL_DRS_REG2MEM_0:%.*]] = phi i1 [ [[CALL_COARSENED_1]], [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_INTRO_1]] ], [ [[CALL]], [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_INTRO_0]] ]
