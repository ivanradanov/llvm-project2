...
; RUN: UNROLL_AND_INTERLEAVE_FACTOR=2 opt -passes=loop-unroll-and-interleave %s -S | FileCheck %s
...
; CHECK-NEXT:    [[CONV6_DRS_REG2MEM_0:%.*]] = phi i32 [ [[CONV6]], [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_DIV_INTRO_0]] ], [ [[CONV6_COARSENED_1]], [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_DIV_INTRO_1]] ]
; CHECK-NEXT:    [[CALL_DRS_REG2MEM_0:%.*]] = phi i1 [ [[CALL]], [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_DIV_INTRO_0]] ], [ [[CALL_COARSENED_1]], [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_DIV_INTRO_1]] ]
