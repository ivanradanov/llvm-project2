...
; CHECK-NEXT:    [[DOTOMP_IV_023:%.*]] = phi i64 [ [[TMP10:%.*]], [[OMP_INNER_FOR_INC:%.*]] ], [ [[TMP1]], [[OMP_INNER_FOR_BODY_PREHEADER]] ]
; CHECK-NEXT:    [[DOTOMP_IV_023_COARSENED_1:%.*]] = phi i64 [ [[DOTCOARSENED_1:%.*]], [[OMP_INNER_FOR_INC]] ], [ [[INITIAL_IV_COARSENED_1]], [[OMP_INNER_FOR_BODY_PREHEADER]] ]
...
; CHECK-NEXT:    [[TMP10]] = add i64 [[COARSENED_STEP]], [[DOTOMP_IV_023]]
; CHECK-NEXT:    [[DOTCOARSENED_1]] = add i64 [[COARSENED_STEP]], [[DOTOMP_IV_023_COARSENED_1]]
; CHECK-NEXT:    [[ADD12:%.*]] = add i64 [[TMP2]], [[DOTOMP_IV_023]]
; CHECK-NEXT:    [[ADD12_COARSENED_1:%.*]] = add i64 [[TMP2]], [[DOTOMP_IV_023_COARSENED_1]]
...
; CHECK-NEXT:    switch i32 [[DR_COARSENED_IDENT3_0]], label [[OMP_INNER_FOR_INC_DIVERGENT_EXIT_DRS_1_OUTRO_0:%.*]] [
...
; CHECK-NEXT:    [[DOTOMP_IV_023_EPILOGUE:%.*]] = phi i64 [ [[ADD12_EPILOGUE:%.*]], [[OMP_INNER_FOR_INC_EPILOGUE:%.*]] ], [ [[TMP10]], [[COARSENED_END_CHECK]] ], [ [[TMP1]], [[OMP_INNER_FOR_BODY_PREHEADER]] ]
...
; DRCHECK-NEXT:    [[DOTOMP_IV_023:%.*]] = phi i64 [ [[TMP12:%.*]], [[OMP_INNER_FOR_INC:%.*]] ], [ [[TMP1]], [[OMP_INNER_FOR_BODY_PREHEADER]] ]
; DRCHECK-NEXT:    [[DOTOMP_IV_023_COARSENED_1:%.*]] = phi i64 [ [[DOTCOARSENED_1:%.*]], [[OMP_INNER_FOR_INC]] ], [ [[INITIAL_IV_COARSENED_1]], [[OMP_INNER_FOR_BODY_PREHEADER]] ]
; DRCHECK-NEXT:    [[CONV6:%.*]] = trunc i64 [[DOTOMP_IV_023]] to i32
...
; DRCHECK-NEXT:    br i1 [[CALL_DRS_0_REG2MEM_0]], label [[IF_THEN_DRS_0:%.*]], label [[IF_ELSE_DRS_0:%.*]]
...
; DRCHECK-NEXT:    br i1 [[CALL8]], label [[IF_THEN9:%.*]], label [[IF_ELSE10:%.*]]
; DRCHECK:       if.then9:
; DRCHECK-NEXT:    call void @_Z4use3Pi(ptr noundef [[A]]) #[[ATTR6]]
; DRCHECK-NEXT:    call void @_Z4use3Pi(ptr noundef [[A]]) #[[ATTR6]]
; DRCHECK-NEXT:    br label [[OMP_INNER_FOR_INC_DIVERGENT_EXIT:%.*]]
; DRCHECK:       if.else10:
; DRCHECK-NEXT:    call void @_Z4use4Pi(ptr noundef [[A]]) #[[ATTR6]]
; DRCHECK-NEXT:    call void @_Z4use4Pi(ptr noundef [[A]]) #[[ATTR6]]
; DRCHECK-NEXT:    br label [[OMP_INNER_FOR_INC_DIVERGENT_EXIT]]
; DRCHECK:       omp.inner.for.inc.divergent.exit:
; DRCHECK-NEXT:    br label [[OMP_INNER_FOR_INC]]
; DRCHECK:       omp.inner.for.inc:
; DRCHECK-NEXT:    [[TMP12]] = add i64 [[COARSENED_STEP]], [[DOTOMP_IV_023]]
; DRCHECK-NEXT:    [[DOTCOARSENED_1]] = add i64 [[COARSENED_STEP]], [[DOTOMP_IV_023_COARSENED_1]]
; DRCHECK-NEXT:    [[ADD12:%.*]] = add i64 [[TMP2]], [[DOTOMP_IV_023]]
; DRCHECK-NEXT:    [[ADD12_COARSENED_1:%.*]] = add i64 [[TMP2]], [[DOTOMP_IV_023_COARSENED_1]]
...
; DRCHECK-NEXT:    br i1 [[CALL8_DRS_1_REG2MEM_0]], label [[IF_THEN9_DRS_1:%.*]], label [[IF_ELSE10_DRS_1:%.*]]
; DRCHECK:       if.then9.drs.1:
; DRCHECK-NEXT:    call void @_Z4use3Pi(ptr noundef [[A]]) #[[ATTR6]]
; DRCHECK-NEXT:    br label [[OMP_INNER_FOR_INC_DIVERGENT_EXIT_DRS_1:%.*]]
; DRCHECK:       if.else10.drs.1:
; DRCHECK-NEXT:    call void @_Z4use4Pi(ptr noundef [[A]]) #[[ATTR6]]
; DRCHECK-NEXT:    br label [[OMP_INNER_FOR_INC_DIVERGENT_EXIT_DRS_1]]
...
; DRCHECK-NEXT:    [[DOTOMP_IV_023_EPILOGUE:%.*]] = phi i64 [ [[ADD12_EPILOGUE:%.*]], [[OMP_INNER_FOR_INC_EPILOGUE:%.*]] ], [ [[TMP12]], [[COARSENED_END_CHECK]] ], [ [[TMP1]], [[OMP_INNER_FOR_BODY_PREHEADER]] ]
; DRCHECK-NEXT:    [[CONV6_EPILOGUE:%.*]] = trunc i64 [[DOTOMP_IV_023_EPILOGUE]] to i32
; DRCHECK-NEXT:    [[CALL_EPILOGUE:%.*]] = call noundef zeroext i1 @_Z5test1i(i32 noundef [[CONV6_EPILOGUE]]) #[[ATTR6]]
; DRCHECK-NEXT:    br i1 [[CALL_EPILOGUE]], label [[IF_THEN_EPILOGUE:%.*]], label [[IF_ELSE_EPILOGUE:%.*]]
...
; DRCHECK-NEXT:    br i1 [[CALL8_EPILOGUE]], label [[IF_THEN9_EPILOGUE:%.*]], label [[IF_ELSE10_EPILOGUE:%.*]]
...
; DRCHECK-NEXT:    [[ADD12_EPILOGUE]] = add i64 [[TMP2]], [[DOTOMP_IV_023_EPILOGUE]]
