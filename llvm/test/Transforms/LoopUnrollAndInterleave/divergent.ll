...
; CHECK-NEXT:    %"mul10.drs.%d0" = mul nsw i32 [[TMP11]], 3
; CHECK-NEXT:    store i32 %"mul10.drs.%d0", ptr poison, align 4, !tbaa [[TBAA16]]
; CHECK-NEXT:    br label %"omp.inner.for.inc.divergent.exit.drs.%d0"
; CHECK:       "sw.bb.drs.%d0":
; CHECK-NEXT:    [[TMP12:%.*]] = load i32, ptr [[A]], align 4, !tbaa [[TBAA16]]
; CHECK-NEXT:    %"mul6.drs.%d0" = shl nsw i32 [[TMP12]], 1
; CHECK-NEXT:    store i32 %"mul6.drs.%d0", ptr [[A]], align 4, !tbaa [[TBAA16]]
; CHECK-NEXT:    br label %"omp.inner.for.inc.divergent.exit.drs.%d0"
; CHECK:       "sw.default.drs.%d0":
; CHECK-NEXT:    %"arrayidx12.drs.%d0" = getelementptr inbounds i32, ptr [[A]], i64 %".omp.iv.033.drs.%d0.reg2mem.0"
; CHECK-NEXT:    [[TMP13:%.*]] = load i32, ptr %"arrayidx12.drs.%d0", align 4, !tbaa [[TBAA16]]
; CHECK-NEXT:    %"mul13.drs.%d0" = shl nsw i32 [[TMP13]], 2
; CHECK-NEXT:    store i32 %"mul13.drs.%d0", ptr %"arrayidx12.drs.%d0", align 4, !tbaa [[TBAA16]]
; CHECK-NEXT:    br label %"omp.inner.for.inc.divergent.exit.drs.%d0"
...
; CHECK-NEXT:    %".omp.iv.033.drs.%d0.reg2mem.0" = phi i64 [ [[DOTOMP_IV_033]], %"omp.inner.for.body.divergent.entry.drs.%d0.intro.0" ], [ [[DOTOMP_IV_033_COARSENED_1]], %"omp.inner.for.body.divergent.entry.drs.%d0.intro.1" ]
; CHECK-NEXT:    switch i64 %".omp.iv.033.drs.%d0.reg2mem.0", label %"sw.default.drs.%d0" [
; CHECK-NEXT:    i64 0, label %"sw.bb.drs.%d0"
; CHECK-NEXT:    i64 1, label %"sw.bb8.drs.%d0"
; CHECK-NEXT:    ]
...
; CHECK-NEXT:    ret void
;
; DRCHECK-LABEL: define internal void @__omp_offloading_4e_5cb4cb97__Z6vecaddPii_l7_omp_outlined_omp_outlined(
; DRCHECK-SAME: ptr noalias nocapture noundef readonly [[DOTGLOBAL_TID_:%.*]], ptr noalias nocapture readnone [[DOTBOUND_TID_:%.*]], i64 noundef [[DOTPREVIOUS_LB_:%.*]], i64 noundef [[DOTPREVIOUS_UB_:%.*]], i64 noundef [[SIZE:%.*]], ptr nocapture noundef [[A:%.*]]) #[[ATTR2:[0-9]+]] {
; DRCHECK-NEXT:  entry:
...
; DRCHECK-NEXT:    call void @__kmpc_for_static_init_8u(ptr addrspacecast (ptr addrspace(1) @anon.28ae86189fb9e802c4de080914343e0f.3 to ptr), i32 [[TMP0]], i32 33, ptr nonnull [[DOTOMP_IS_LAST_ASCAST]], ptr nonnull [[DOTOMP_LB_ASCAST]], ptr nonnull [[DOTOMP_UB_ASCAST]], ptr nonnull [[DOTOMP_STRIDE_ASCAST]], i64 1, i64 1) #[[ATTR1]]
; DRCHECK-NEXT:    [[TMP1:%.*]] = load i64, ptr addrspace(5) [[DOTOMP_LB]], align 8, !tbaa [[TBAA12]]
; DRCHECK-NEXT:    [[ADD:%.*]] = add i64 [[DOTPREVIOUS_UB_]], 1
; DRCHECK-NEXT:    [[CMP432:%.*]] = icmp ult i64 [[TMP1]], [[ADD]]
; DRCHECK-NEXT:    br i1 [[CMP432]], label [[OMP_INNER_FOR_BODY_LR_PH:%.*]], label [[OMP_LOOP_EXIT:%.*]]
; DRCHECK:       omp.inner.for.body.lr.ph:
; DRCHECK-NEXT:    [[TMP2:%.*]] = load i64, ptr addrspace(5) [[DOTOMP_STRIDE]], align 8, !tbaa [[TBAA12]]
; DRCHECK-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds i32, ptr [[A]], i64 1
...
; DRCHECK-NEXT:    [[DOTOMP_IV_033:%.*]] = phi i64 [ [[TMP1]], [[OMP_INNER_FOR_BODY_LR_PH]] ], [ [[ADD15:%.*]], [[OMP_INNER_FOR_INC:%.*]] ]
; DRCHECK-NEXT:    [[DOTOMP_IV_033_COARSENED_1:%.*]] = phi i64 [ [[INITIAL_IV_COARSENED_1]], [[OMP_INNER_FOR_BODY_LR_PH]] ], [ [[ADD15_COARSENED_1:%.*]], [[OMP_INNER_FOR_INC]] ]
; DRCHECK-NEXT:    [[TMP11:%.*]] = icmp eq i64 [[DOTOMP_IV_033_COARSENED_1]], [[DOTOMP_IV_033]]
...
; DRCHECK-NEXT:    switch i64 [[DOTOMP_IV_033]], label [[SW_DEFAULT:%.*]] [
; DRCHECK-NEXT:    i64 0, label [[SW_BB:%.*]]
; DRCHECK-NEXT:    i64 1, label [[SW_BB8:%.*]]
; DRCHECK-NEXT:    ]
; DRCHECK:       sw.bb:
; DRCHECK-NEXT:    [[TMP13:%.*]] = load i32, ptr [[A]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    [[DOTCOARSENED_11:%.*]] = load i32, ptr [[A]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    [[MUL6:%.*]] = shl nsw i32 [[TMP13]], 1
; DRCHECK-NEXT:    [[MUL6_COARSENED_1:%.*]] = shl nsw i32 [[DOTCOARSENED_11]], 1
; DRCHECK-NEXT:    store i32 [[MUL6]], ptr [[A]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    store i32 [[MUL6_COARSENED_1]], ptr [[A]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    br label [[OMP_INNER_FOR_INC_DIVERGENT_EXIT:%.*]]
; DRCHECK:       sw.bb8:
; DRCHECK-NEXT:    [[TMP14:%.*]] = load i32, ptr [[ARRAYIDX9]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    [[DOTCOARSENED_1:%.*]] = load i32, ptr [[ARRAYIDX9]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    [[MUL10:%.*]] = mul nsw i32 [[TMP14]], 3
; DRCHECK-NEXT:    [[MUL10_COARSENED_1:%.*]] = mul nsw i32 [[DOTCOARSENED_1]], 3
; DRCHECK-NEXT:    store i32 [[MUL10]], ptr [[ARRAYIDX9]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    store i32 [[MUL10_COARSENED_1]], ptr [[ARRAYIDX9]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    br label [[OMP_INNER_FOR_INC_DIVERGENT_EXIT]]
; DRCHECK:       sw.default:
; DRCHECK-NEXT:    [[ARRAYIDX12:%.*]] = getelementptr inbounds i32, ptr [[A]], i64 [[DOTOMP_IV_033]]
; DRCHECK-NEXT:    [[ARRAYIDX12_COARSENED_1:%.*]] = getelementptr inbounds i32, ptr [[A]], i64 [[DOTOMP_IV_033_COARSENED_1]]
; DRCHECK-NEXT:    [[TMP15:%.*]] = load i32, ptr [[ARRAYIDX12]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    [[DOTCOARSENED_12:%.*]] = load i32, ptr [[ARRAYIDX12_COARSENED_1]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    [[MUL13:%.*]] = shl nsw i32 [[TMP15]], 2
; DRCHECK-NEXT:    [[MUL13_COARSENED_1:%.*]] = shl nsw i32 [[DOTCOARSENED_12]], 2
; DRCHECK-NEXT:    store i32 [[MUL13]], ptr [[ARRAYIDX12]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    store i32 [[MUL13_COARSENED_1]], ptr [[ARRAYIDX12_COARSENED_1]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    br label [[OMP_INNER_FOR_INC_DIVERGENT_EXIT]]
...
; DRCHECK-NEXT:    [[ADD15]] = add i64 [[COARSENED_STEP]], [[DOTOMP_IV_033]]
; DRCHECK-NEXT:    [[ADD15_COARSENED_1]] = add i64 [[COARSENED_STEP]], [[DOTOMP_IV_033_COARSENED_1]]
; DRCHECK-NEXT:    [[CMP4:%.*]] = icmp ult i64 [[ADD15]], [[ADD]]
; DRCHECK-NEXT:    [[CMP4_COARSENED_1:%.*]] = icmp ult i64 [[ADD15_COARSENED_1]], [[ADD]]
; DRCHECK-NEXT:    [[IS_EPILOGUE_START5:%.*]] = icmp eq i64 [[ADD15]], [[EPILOGUE_START_IV]]
...
; DRCHECK-NEXT:    br i1 [[IS_EPILOGUE_START5]], label [[OMP_INNER_FOR_BODY_EPILOGUE]], label [[OMP_INNER_FOR_INC]]
...
; DRCHECK:       "sw.bb8.drs.%d0":
; DRCHECK-NEXT:    [[TMP16:%.*]] = load i32, ptr poison, align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    %"mul10.drs.%d0" = mul nsw i32 [[TMP16]], 3
; DRCHECK-NEXT:    store i32 %"mul10.drs.%d0", ptr poison, align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    br label %"omp.inner.for.inc.divergent.exit.drs.%d0"
; DRCHECK:       "sw.bb.drs.%d0":
; DRCHECK-NEXT:    [[TMP17:%.*]] = load i32, ptr [[A]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    %"mul6.drs.%d0" = shl nsw i32 [[TMP17]], 1
; DRCHECK-NEXT:    store i32 %"mul6.drs.%d0", ptr [[A]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    br label %"omp.inner.for.inc.divergent.exit.drs.%d0"
; DRCHECK:       "sw.default.drs.%d0":
; DRCHECK-NEXT:    %"arrayidx12.drs.%d0" = getelementptr inbounds i32, ptr [[A]], i64 %".omp.iv.033.drs.%d0.reg2mem.0"
; DRCHECK-NEXT:    [[TMP18:%.*]] = load i32, ptr %"arrayidx12.drs.%d0", align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    %"mul13.drs.%d0" = shl nsw i32 [[TMP18]], 2
; DRCHECK-NEXT:    store i32 %"mul13.drs.%d0", ptr %"arrayidx12.drs.%d0", align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    br label %"omp.inner.for.inc.divergent.exit.drs.%d0"
...
; DRCHECK-NEXT:    %".omp.iv.033.drs.%d0.reg2mem.0" = phi i64 [ [[DOTOMP_IV_033]], %"omp.inner.for.body.divergent.entry.drs.%d0.intro.0" ], [ [[DOTOMP_IV_033_COARSENED_1]], %"omp.inner.for.body.divergent.entry.drs.%d0.intro.1" ]
; DRCHECK-NEXT:    switch i64 %".omp.iv.033.drs.%d0.reg2mem.0", label %"sw.default.drs.%d0" [
; DRCHECK-NEXT:    i64 0, label %"sw.bb.drs.%d0"
; DRCHECK-NEXT:    i64 1, label %"sw.bb8.drs.%d0"
; DRCHECK-NEXT:    ]
...
; DRCHECK-NEXT:    [[DOTOMP_IV_033_EPILOGUE:%.*]] = phi i64 [ [[ADD15]], [[OMP_INNER_FOR_INCEPILOGUE_START_CHECK]] ], [ [[ADD15_EPILOGUE:%.*]], [[OMP_INNER_FOR_INC_EPILOGUE:%.*]] ], [ [[TMP1]], [[OMP_INNER_FOR_BODY_LR_PH]] ]
; DRCHECK-NEXT:    br label [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_EPILOGUE:%.*]]
; DRCHECK:       sw.bb8.epilogue:
; DRCHECK-NEXT:    [[TMP19:%.*]] = load i32, ptr [[ARRAYIDX9]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    [[MUL10_EPILOGUE:%.*]] = mul nsw i32 [[TMP19]], 3
; DRCHECK-NEXT:    store i32 [[MUL10_EPILOGUE]], ptr [[ARRAYIDX9]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    br label [[OMP_INNER_FOR_INC_DIVERGENT_EXIT_EPILOGUE:%.*]]
; DRCHECK:       sw.bb.epilogue:
; DRCHECK-NEXT:    [[TMP20:%.*]] = load i32, ptr [[A]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    [[MUL6_EPILOGUE:%.*]] = shl nsw i32 [[TMP20]], 1
; DRCHECK-NEXT:    store i32 [[MUL6_EPILOGUE]], ptr [[A]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    br label [[OMP_INNER_FOR_INC_DIVERGENT_EXIT_EPILOGUE]]
; DRCHECK:       sw.default.epilogue:
; DRCHECK-NEXT:    [[ARRAYIDX12_EPILOGUE:%.*]] = getelementptr inbounds i32, ptr [[A]], i64 [[DOTOMP_IV_033_EPILOGUE]]
; DRCHECK-NEXT:    [[TMP21:%.*]] = load i32, ptr [[ARRAYIDX12_EPILOGUE]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    [[MUL13_EPILOGUE:%.*]] = shl nsw i32 [[TMP21]], 2
; DRCHECK-NEXT:    store i32 [[MUL13_EPILOGUE]], ptr [[ARRAYIDX12_EPILOGUE]], align 4, !tbaa [[TBAA16]]
; DRCHECK-NEXT:    br label [[OMP_INNER_FOR_INC_DIVERGENT_EXIT_EPILOGUE]]
; DRCHECK:       omp.inner.for.inc.epilogue:
; DRCHECK-NEXT:    [[ADD15_EPILOGUE]] = add i64 [[TMP2]], [[DOTOMP_IV_033_EPILOGUE]]
...
; DRCHECK-NEXT:    switch i64 [[DOTOMP_IV_033_EPILOGUE]], label [[SW_DEFAULT_EPILOGUE:%.*]] [
; DRCHECK-NEXT:    i64 0, label [[SW_BB_EPILOGUE:%.*]]
; DRCHECK-NEXT:    i64 1, label [[SW_BB8_EPILOGUE:%.*]]
; DRCHECK-NEXT:    ]
...
; DRCHECK-NEXT:    call void @__kmpc_distribute_static_fini(ptr addrspacecast (ptr addrspace(1) @anon.28ae86189fb9e802c4de080914343e0f.2 to ptr), i32 [[TMP0]]) #[[ATTR1]]
