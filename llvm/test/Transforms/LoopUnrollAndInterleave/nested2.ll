...
; DRCHECK-NEXT:    br i1 [[TMP14]], label [[IF_THEN_DIVERGENT_ENTRY:%.*]], label [[IF_THEN_DIVERGENT_ENTRY_DRS_1_INTRO_0:%.*]]
...
; DRCHECK-NEXT:    br i1 [[TMP16]], label [[IF_THEN9_DIVERGENT_ENTRY:%.*]], label [[IF_THEN9_DIVERGENT_ENTRY_DRS_2_INTRO_0:%.*]]
