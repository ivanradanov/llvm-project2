...
; CHECK-NEXT:    [[DOTOMP_IV_026_EPILOGUE:%.*]] = phi i64 [ [[ADD15]], [[COARSENED_END_CHECK]] ], [ [[ADD15_EPILOGUE:%.*]], [[OMP_INNER_FOR_INC_EPILOGUE:%.*]] ], [ [[TMP1]], [[OMP_INNER_FOR_BODY_LR_PH]] ]
...
; DRCHECK-NEXT:    br i1 [[TMP12]], label [[IF_THEN_DIVERGENT_ENTRY:%.*]], label [[IF_THEN_DIVERGENT_ENTRY_DRS_1_INTRO_0:%.*]]
...
; DRCHECK-NEXT:    [[TMP13:%.*]] = icmp eq i1 [[CALL11_COARSENED_1]], [[CALL11]]
; DRCHECK-NEXT:    br i1 [[TMP13]], label [[IF_THEN9_DIVERGENT_ENTRY:%.*]], label [[IF_THEN9_DIVERGENT_ENTRY_DRS_2_INTRO_0:%.*]]
...
; DRCHECK-NEXT:    br i1 [[IS_EPILOGUE_START9]], label [[COARSENED_END_CHECK:%.*]], label [[OMP_INNER_FOR_BODY]], !llvm.loop [[LOOP18:![0-9]+]]
...
; DRCHECK-NEXT:    [[DR_COARSENED_IDENT7_0:%.*]] = phi i32 [ 0, [[IF_THEN9_DIVERGENT_ENTRY_DRS_2_INTRO_0]] ], [ 1, [[IF_THEN9_DIVERGENT_ENTRY_DRS_2_INTRO_1:%.*]] ]
...
; DRCHECK-NEXT:    switch i32 [[DR_COARSENED_IDENT7_0]], label [[OMP_INNER_FOR_INC_DIVERGENT_EXIT_DRS_2_OUTRO_0:%.*]] [
...
; DRCHECK-NEXT:    [[DR_COARSENED_IDENT5_0:%.*]] = phi i32 [ 0, [[IF_THEN_DIVERGENT_ENTRY_DRS_1_INTRO_0]] ], [ 1, [[IF_THEN_DIVERGENT_ENTRY_DRS_1_INTRO_1:%.*]] ]
...
; DRCHECK-NEXT:    switch i32 [[DR_COARSENED_IDENT5_0]], label [[OMP_INNER_FOR_INC_DIVERGENT_EXIT_DRS_1_OUTRO_0:%.*]] [
...
; DRCHECK-NEXT:    [[DOTOMP_IV_026_EPILOGUE:%.*]] = phi i64 [ [[ADD15]], [[COARSENED_END_CHECK]] ], [ [[ADD15_EPILOGUE:%.*]], [[OMP_INNER_FOR_INC_EPILOGUE:%.*]] ], [ [[TMP1]], [[OMP_INNER_FOR_BODY_LR_PH]] ]
