...
; }
;
; b (defined in a DR) is used only as a operand to a br instruction in another
; DR, check if he handle this correctly.
...
; CHECK-NEXT:    [[B_0_REG2MEM_0:%.*]] = phi i1 [ undef, [[OMP_INNER_FOR_BODY_LR_PH]] ], [ [[B_0_REG2MEM_1:%.*]], [[IF_END10:%.*]] ]
; CHECK-NEXT:    [[DOTOMP_IV_019:%.*]] = phi i64 [ [[TMP1]], [[OMP_INNER_FOR_BODY_LR_PH]] ], [ [[TMP10:%.*]], [[IF_END10]] ]
; CHECK-NEXT:    [[DOTOMP_IV_019_COARSENED_1:%.*]] = phi i64 [ [[INITIAL_IV_COARSENED_1]], [[OMP_INNER_FOR_BODY_LR_PH]] ], [ [[DOTCOARSENED_1:%.*]], [[IF_END10]] ]
...
; CHECK-NEXT:    [[B_0_REG2MEM_1]] = phi i1 [ [[B_0_REG2MEM_0]], [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_0_INTRO_0]] ], [ [[B_0_DRS_0:%.*]], [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_0_INTRO_1]] ]
...
; CHECK-NEXT:    [[B_0_DRS_0]] = phi i1 [ true, [[IF_THEN_DRS_0]] ], [ false, [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_0]] ]
...
; CHECK:       if.end10:
; CHECK-NEXT:    [[TMP10]] = add i64 [[COARSENED_STEP]], [[DOTOMP_IV_019]]
; CHECK-NEXT:    [[DOTCOARSENED_1]] = add i64 [[COARSENED_STEP]], [[DOTOMP_IV_019_COARSENED_1]]
; CHECK-NEXT:    [[ADD11:%.*]] = add i64 [[TMP2]], [[DOTOMP_IV_019]]
; CHECK-NEXT:    [[ADD11_COARSENED_1:%.*]] = add i64 [[TMP2]], [[DOTOMP_IV_019_COARSENED_1]]
...
; CHECK-NEXT:    [[DR_COARSENED_IDENT3_0:%.*]] = phi i32 [ 0, [[IF_END_DIVERGENT_ENTRY_DRS_1_INTRO_0]] ], [ 1, [[IF_END_DIVERGENT_ENTRY_DRS_1_INTRO_1:%.*]] ]
; CHECK-NEXT:    [[B_0_DRS_1_REG2MEM_0:%.*]] = phi i1 [ [[B_0_REG2MEM_1]], [[IF_END_DIVERGENT_ENTRY_DRS_1_INTRO_0]] ], [ [[B_0_DRS_0]], [[IF_END_DIVERGENT_ENTRY_DRS_1_INTRO_1]] ]
; CHECK-NEXT:    br i1 [[B_0_DRS_1_REG2MEM_0]], label [[IF_THEN9_DRS_1:%.*]], label [[IF_END10_DIVERGENT_EXIT_DRS_1:%.*]]
; CHECK:       if.then9.drs.1:
; CHECK-NEXT:    tail call void @usei1(i1 true) #[[ATTR6]]
; CHECK-NEXT:    br label [[IF_END10_DIVERGENT_EXIT_DRS_1]]
; CHECK:       if.end10.divergent.exit.drs.1:
; CHECK-NEXT:    switch i32 [[DR_COARSENED_IDENT3_0]], label [[IF_END10_DIVERGENT_EXIT_DRS_1_OUTRO_0:%.*]] [
...
; CHECK-NEXT:    [[DOTOMP_IV_019_EPILOGUE:%.*]] = phi i64 [ [[TMP10]], [[COARSENED_END_CHECK]] ], [ [[ADD11_EPILOGUE:%.*]], [[IF_END10_EPILOGUE:%.*]] ], [ [[TMP1]], [[OMP_INNER_FOR_BODY_LR_PH]] ]
...
; CHECK-NEXT:    [[B_0_EPILOGUE:%.*]] = phi i1 [ true, [[IF_THEN_EPILOGUE]] ], [ false, [[OMP_INNER_FOR_BODY_EPILOGUE]] ]
; CHECK-NEXT:    br i1 [[B_0_EPILOGUE]], label [[IF_THEN9_EPILOGUE:%.*]], label [[IF_END10_EPILOGUE]]
...
; DRCHECK-NEXT:    [[B_0_REG2MEM_0:%.*]] = phi i1 [ undef, [[OMP_INNER_FOR_BODY_LR_PH]] ], [ [[B_0_REG2MEM_1:%.*]], [[IF_END10:%.*]] ]
; DRCHECK-NEXT:    [[DOTOMP_IV_019:%.*]] = phi i64 [ [[TMP1]], [[OMP_INNER_FOR_BODY_LR_PH]] ], [ [[TMP12:%.*]], [[IF_END10]] ]
; DRCHECK-NEXT:    [[DOTOMP_IV_019_COARSENED_1:%.*]] = phi i64 [ [[INITIAL_IV_COARSENED_1]], [[OMP_INNER_FOR_BODY_LR_PH]] ], [ [[DOTCOARSENED_1:%.*]], [[IF_END10]] ]
...
; DRCHECK-NEXT:    [[B_0:%.*]] = phi i1 [ true, [[IF_THEN]] ], [ false, [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY]] ]
; DRCHECK-NEXT:    [[B_0_COARSENED_1:%.*]] = phi i1 [ true, [[IF_THEN]] ], [ false, [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY]] ]
; DRCHECK-NEXT:    br label [[IF_END:%.*]]
; DRCHECK:       if.end:
; DRCHECK-NEXT:    [[B_0_REG2MEM_1]] = phi i1 [ [[B_0]], [[IF_END_DIVERGENT_EXIT]] ], [ [[B_0_REG2MEM_2:%.*]], [[IF_END_DIVERGENT_EXIT_DRS_0_OUTRO_1:%.*]] ]
; DRCHECK-NEXT:    [[B_0_COARSENED_1_REG2MEM_0:%.*]] = phi i1 [ [[B_0_COARSENED_1]], [[IF_END_DIVERGENT_EXIT]] ], [ [[B_0_DRS_0:%.*]], [[IF_END_DIVERGENT_EXIT_DRS_0_OUTRO_1]] ]
; DRCHECK-NEXT:    [[TMP11:%.*]] = icmp eq i1 [[B_0_COARSENED_1_REG2MEM_0]], [[B_0_REG2MEM_1]]
...
; DRCHECK-NEXT:    [[B_0_REG2MEM_2]] = phi i1 [ [[B_0_REG2MEM_0]], [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_0_INTRO_0]] ], [ [[B_0_DRS_0]], [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_0_INTRO_1]] ]
...
; DRCHECK-NEXT:    [[B_0_DRS_0]] = phi i1 [ true, [[IF_THEN_DRS_0]] ], [ false, [[OMP_INNER_FOR_BODY_DIVERGENT_ENTRY_DRS_0]] ]
...
; DRCHECK-NEXT:    br i1 [[B_0_REG2MEM_1]], label [[IF_THEN9:%.*]], label [[IF_END10_DIVERGENT_EXIT:%.*]]
; DRCHECK:       if.then9:
; DRCHECK-NEXT:    tail call void @usei1(i1 true) #[[ATTR6]]
; DRCHECK-NEXT:    tail call void @usei1(i1 true) #[[ATTR6]]
; DRCHECK-NEXT:    br label [[IF_END10_DIVERGENT_EXIT]]
; DRCHECK:       if.end10.divergent.exit:
; DRCHECK-NEXT:    br label [[IF_END10]]
; DRCHECK:       if.end10:
; DRCHECK-NEXT:    [[TMP12]] = add i64 [[COARSENED_STEP]], [[DOTOMP_IV_019]]
; DRCHECK-NEXT:    [[DOTCOARSENED_1]] = add i64 [[COARSENED_STEP]], [[DOTOMP_IV_019_COARSENED_1]]
; DRCHECK-NEXT:    [[ADD11:%.*]] = add i64 [[TMP2]], [[DOTOMP_IV_019]]
; DRCHECK-NEXT:    [[ADD11_COARSENED_1:%.*]] = add i64 [[TMP2]], [[DOTOMP_IV_019_COARSENED_1]]
; DRCHECK-NEXT:    [[CMP4:%.*]] = icmp ult i64 [[ADD11]], [[ADD]]
; DRCHECK-NEXT:    [[CMP4_COARSENED_1:%.*]] = icmp ult i64 [[ADD11_COARSENED_1]], [[ADD]]
; DRCHECK-NEXT:    [[TMP13:%.*]] = icmp ult i64 [[TMP12]], [[ADD]]
; DRCHECK-NEXT:    [[DOTCOARSENED_12:%.*]] = icmp ult i64 [[DOTCOARSENED_1]], [[ADD]]
; DRCHECK-NEXT:    [[IS_EPILOGUE_START1:%.*]] = icmp eq i64 [[TMP12]], [[EPILOGUE_START_IV]]
...
; DRCHECK-NEXT:    [[DR_COARSENED_IDENT5_0:%.*]] = phi i32 [ 0, [[IF_END_DIVERGENT_ENTRY_DRS_1_INTRO_0]] ], [ 1, [[IF_END_DIVERGENT_ENTRY_DRS_1_INTRO_1:%.*]] ]
; DRCHECK-NEXT:    [[B_0_DRS_1_REG2MEM_0:%.*]] = phi i1 [ [[B_0_REG2MEM_1]], [[IF_END_DIVERGENT_ENTRY_DRS_1_INTRO_0]] ], [ [[B_0_COARSENED_1_REG2MEM_0]], [[IF_END_DIVERGENT_ENTRY_DRS_1_INTRO_1]] ]
; DRCHECK-NEXT:    br i1 [[B_0_DRS_1_REG2MEM_0]], label [[IF_THEN9_DRS_1:%.*]], label [[IF_END10_DIVERGENT_EXIT_DRS_1:%.*]]
; DRCHECK:       if.then9.drs.1:
; DRCHECK-NEXT:    tail call void @usei1(i1 true) #[[ATTR6]]
; DRCHECK-NEXT:    br label [[IF_END10_DIVERGENT_EXIT_DRS_1]]
; DRCHECK:       if.end10.divergent.exit.drs.1:
; DRCHECK-NEXT:    switch i32 [[DR_COARSENED_IDENT5_0]], label [[IF_END10_DIVERGENT_EXIT_DRS_1_OUTRO_0:%.*]] [
...
; DRCHECK-NEXT:    br i1 [[TMP13]], label [[OMP_INNER_FOR_BODY_EPILOGUE]], label [[OMP_LOOP_EXIT_LOOPEXIT:%.*]]
; DRCHECK:       omp.inner.for.body.epilogue:
; DRCHECK-NEXT:    [[DOTOMP_IV_019_EPILOGUE:%.*]] = phi i64 [ [[TMP12]], [[COARSENED_END_CHECK]] ], [ [[ADD11_EPILOGUE:%.*]], [[IF_END10_EPILOGUE:%.*]] ], [ [[TMP1]], [[OMP_INNER_FOR_BODY_LR_PH]] ]
...
; DRCHECK-NEXT:    [[B_0_EPILOGUE:%.*]] = phi i1 [ true, [[IF_THEN_EPILOGUE]] ], [ false, [[OMP_INNER_FOR_BODY_EPILOGUE]] ]
; DRCHECK-NEXT:    br i1 [[B_0_EPILOGUE]], label [[IF_THEN9_EPILOGUE:%.*]], label [[IF_END10_EPILOGUE]]
...
if.end:                                           ; preds = %if.then, %omp.inner.for.body
  %b.0 = phi i1 [ 1, %if.then ], [ 0, %omp.inner.for.body ]
  br i1 %b.0, label %if.then9, label %if.end10

if.then9:                                         ; preds = %if.end
  tail call void @usei1(i1 true) #8
  br label %if.end10
...
declare void @usei1(i1 noundef) local_unnamed_addr #4
