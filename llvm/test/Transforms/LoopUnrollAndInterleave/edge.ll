...
; CHECK-NEXT:    [[TMP6:%.*]] = mul i32 [[TMP3]], 1
; CHECK-NEXT:    [[INITIAL_IV_COARSENED_1:%.*]] = add i32 [[TMP2]], [[TMP6]]
; CHECK-NEXT:    [[TMP7:%.*]] = sub i32 [[CONV5_I]], [[TMP2]]
; CHECK-NEXT:    [[TMP8:%.*]] = add i32 [[TMP7]], [[TMP3]]
; CHECK-NEXT:    [[TMP9:%.*]] = sub i32 [[TMP8]], 1
; CHECK-NEXT:    [[TMP10:%.*]] = udiv i32 [[TMP9]], [[TMP3]]
; CHECK-NEXT:    [[TMP11:%.*]] = udiv i32 [[TMP10]], 2
; CHECK-NEXT:    [[TMP12:%.*]] = mul nsw i32 [[TMP11]], 2
; CHECK-NEXT:    [[TMP13:%.*]] = mul nsw i32 [[TMP12]], [[TMP3]]
; CHECK-NEXT:    [[EPILOGUE_START_IV:%.*]] = add i32 [[TMP13]], [[TMP2]]
...
; CHECK-NEXT:    [[TMP14:%.*]] = load i8, ptr [[ARRAYIDX_I]], align 1, !tbaa [[TBAA21:![0-9]+]], !noalias [[META14]]
; CHECK-NEXT:    [[DOTCOARSENED_1:%.*]] = load i8, ptr [[ARRAYIDX_I_COARSENED_1]], align 1, !tbaa [[TBAA21]], !noalias [[META22:![0-9]+]]
...
; CHECK-NEXT:    [[TMP15:%.*]] = load i8, ptr [[ARRAYIDX19_I]], align 1, !tbaa [[TBAA21]], !noalias [[META14]]
; CHECK-NEXT:    [[DOTCOARSENED_11:%.*]] = load i8, ptr [[ARRAYIDX19_I_COARSENED_1]], align 1, !tbaa [[TBAA21]], !noalias [[META22]]
; CHECK-NEXT:    [[CMP21_NOT_I:%.*]] = icmp ne i8 [[TMP14]], [[TMP15]]
; CHECK-NEXT:    [[CMP21_NOT_I_COARSENED_1:%.*]] = icmp ne i8 [[DOTCOARSENED_1]], [[DOTCOARSENED_11]]
...
; CHECK-NEXT:    br i1 [[EXITCOND_NOT_I]], label [[FOR_COND_CLEANUP12_I_LOOPEXIT]], label [[FOR_BODY13_I]], !llvm.loop [[LOOP25:![0-9]+]]
...
; CHECK-NEXT:    [[IS_EPILOGUE_START5:%.*]] = icmp eq i32 [[ADD34_I]], [[EPILOGUE_START_IV]]
; CHECK-NEXT:    br i1 [[IS_EPILOGUE_START5]], label [[COARSENED_END_CHECK:%.*]], label [[OMP_INNER_FOR_BODY_I]], !llvm.loop [[LOOP27:![0-9]+]]
...
; CHECK-NEXT:    [[TMP16:%.*]] = load i8, ptr [[ARRAYIDX_I_DRS_0]], align 1, !tbaa [[TBAA21]], !noalias [[META14]]
...
; CHECK-NEXT:    [[TMP17:%.*]] = load i8, ptr [[ARRAYIDX19_I_DRS_0]], align 1, !tbaa [[TBAA21]], !noalias [[META14]]
; CHECK-NEXT:    [[CMP21_NOT_I_DRS_0:%.*]] = icmp ne i8 [[TMP16]], [[TMP17]]
...
; CHECK-NEXT:    br i1 [[EXITCOND_NOT_I_DRS_0]], label [[FOR_COND_CLEANUP12_I_LOOPEXIT_DRS_0:%.*]], label [[FOR_BODY13_I_DRS_0]], !llvm.loop [[LOOP25]]
...
; CHECK-NEXT:    br i1 [[EXITCOND9_NOT_I_DRS_0]], label [[IF_END33_I_LOOPEXIT_DRS_0:%.*]], label [[FOR_COND10_PREHEADER_I_DRS_0:%.*]], !llvm.loop [[LOOP29:![0-9]+]]
...
; CHECK-NEXT:    br i1 [[CMP6_I]], label [[OMP_INNER_FOR_BODY_I_EPILOGUE]], label [[OMP_LOOP_EXIT_I_LOOPEXIT:%.*]], !llvm.loop [[LOOP30:![0-9]+]]
...
; CHECK-NEXT:    br i1 [[CMP9_NOT_NOT4_I]], label [[IF_END33_I_DIVERGENT_EXIT_EPILOGUE:%.*]], label [[FOR_COND10_PREHEADER_LR_PH_I_EPILOGUE:%.*]]
...
; CHECK-NEXT:    [[TMP18:%.*]] = load i8, ptr [[ARRAYIDX_I_EPILOGUE]], align 1, !tbaa [[TBAA21]], !noalias [[META14]]
...
; CHECK-NEXT:    [[TMP19:%.*]] = load i8, ptr [[ARRAYIDX19_I_EPILOGUE]], align 1, !tbaa [[TBAA21]], !noalias [[META14]]
; CHECK-NEXT:    [[CMP21_NOT_I_EPILOGUE:%.*]] = icmp ne i8 [[TMP18]], [[TMP19]]
...
; CHECK-NEXT:    br i1 [[EXITCOND_NOT_I_EPILOGUE]], label [[FOR_COND_CLEANUP12_I_LOOPEXIT_EPILOGUE:%.*]], label [[FOR_BODY13_I_EPILOGUE]], !llvm.loop [[LOOP25]]
...
; CHECK:       for.cond.cleanup12.i.divergent.entry.epilogue:
...
; CHECK-NEXT:    br i1 [[EXITCOND9_NOT_I_EPILOGUE]], label [[IF_END33_I_LOOPEXIT_EPILOGUE:%.*]], label [[FOR_COND10_PREHEADER_I_EPILOGUE]], !llvm.loop [[LOOP29]]
; CHECK:       if.end33.i.loopexit.epilogue:
; CHECK-NEXT:    br label [[IF_END33_I_DIVERGENT_EXIT_EPILOGUE]]
...
; CHECK-NEXT:    br i1 [[CMP6_I_EPILOGUE]], label [[OMP_INNER_FOR_BODY_I_EPILOGUE]], label [[OMP_LOOP_EXIT_I_LOOPEXIT]], !llvm.loop [[LOOP32:![0-9]+]]
...
; CHECK-NEXT:    br label [[FOR_COND_CLEANUP12_I_DIVERGENT_ENTRY_EPILOGUE:%.*]]
; CHECK:       if.end33.i.divergent.exit.epilogue:
...
; DRCHECK-NEXT:    [[TMP6:%.*]] = mul i32 [[TMP3]], 1
; DRCHECK-NEXT:    [[INITIAL_IV_COARSENED_1:%.*]] = add i32 [[TMP2]], [[TMP6]]
; DRCHECK-NEXT:    [[TMP7:%.*]] = sub i32 [[CONV5_I]], [[TMP2]]
; DRCHECK-NEXT:    [[TMP8:%.*]] = add i32 [[TMP7]], [[TMP3]]
; DRCHECK-NEXT:    [[TMP9:%.*]] = sub i32 [[TMP8]], 1
; DRCHECK-NEXT:    [[TMP10:%.*]] = udiv i32 [[TMP9]], [[TMP3]]
; DRCHECK-NEXT:    [[TMP11:%.*]] = udiv i32 [[TMP10]], 2
; DRCHECK-NEXT:    [[TMP12:%.*]] = mul nsw i32 [[TMP11]], 2
; DRCHECK-NEXT:    [[TMP13:%.*]] = mul nsw i32 [[TMP12]], [[TMP3]]
; DRCHECK-NEXT:    [[EPILOGUE_START_IV:%.*]] = add i32 [[TMP13]], [[TMP2]]
...
; DRCHECK-NEXT:    [[TMP15:%.*]] = load i8, ptr [[ARRAYIDX_I]], align 1, !tbaa [[TBAA23:![0-9]+]], !noalias [[META14]]
; DRCHECK-NEXT:    [[DOTCOARSENED_1:%.*]] = load i8, ptr [[ARRAYIDX_I_COARSENED_1]], align 1, !tbaa [[TBAA23]], !noalias [[META24:![0-9]+]]
...
; DRCHECK-NEXT:    [[TMP16:%.*]] = load i8, ptr [[ARRAYIDX19_I]], align 1, !tbaa [[TBAA23]], !noalias [[META14]]
; DRCHECK-NEXT:    [[DOTCOARSENED_11:%.*]] = load i8, ptr [[ARRAYIDX19_I_COARSENED_1]], align 1, !tbaa [[TBAA23]], !noalias [[META24]]
...
; DRCHECK-NEXT:    br i1 [[EXITCOND_NOT_I]], label [[FOR_COND_CLEANUP12_I_LOOPEXIT]], label [[FOR_BODY13_I]], !llvm.loop [[LOOP27:![0-9]+]]
; DRCHECK:       cleanup28.i:
...
; DRCHECK-NEXT:    store i8 1, ptr [[ARRAYIDX32_I_COARSENED_1]], align 1, !tbaa [[TBAA23]], !noalias [[META24]]
...
; DRCHECK-NEXT:    [[IS_EPILOGUE_START5:%.*]] = icmp eq i32 [[ADD34_I]], [[EPILOGUE_START_IV]]
; DRCHECK-NEXT:    br i1 [[IS_EPILOGUE_START5]], label [[COARSENED_END_CHECK:%.*]], label [[OMP_INNER_FOR_BODY_I]], !llvm.loop [[LOOP28:![0-9]+]]
...
; DRCHECK-NEXT:    [[TMP17:%.*]] = load i8, ptr [[ARRAYIDX_I_DRS_0]], align 1, !tbaa [[TBAA23]], !noalias [[META14]]
...
; DRCHECK-NEXT:    [[TMP18:%.*]] = load i8, ptr [[ARRAYIDX19_I_DRS_0]], align 1, !tbaa [[TBAA23]], !noalias [[META14]]
...
; DRCHECK-NEXT:    br i1 [[EXITCOND_NOT_I_DRS_0]], label [[FOR_COND_CLEANUP12_I_LOOPEXIT_DRS_0:%.*]], label [[FOR_BODY13_I_DRS_0]], !llvm.loop [[LOOP27]]
...
; DRCHECK-NEXT:    br i1 [[CMP6_I]], label [[OMP_INNER_FOR_BODY_I_EPILOGUE]], label [[OMP_LOOP_EXIT_I_LOOPEXIT:%.*]], !llvm.loop [[LOOP30:![0-9]+]]
...
; DRCHECK-NEXT:    br i1 [[CMP9_NOT_NOT4_I]], label [[IF_END33_I_DIVERGENT_EXIT_EPILOGUE:%.*]], label [[FOR_COND10_PREHEADER_LR_PH_I_EPILOGUE:%.*]]
...
; DRCHECK-NEXT:    [[TMP19:%.*]] = load i8, ptr [[ARRAYIDX_I_EPILOGUE]], align 1, !tbaa [[TBAA23]], !noalias [[META14]]
...
; DRCHECK-NEXT:    [[TMP20:%.*]] = load i8, ptr [[ARRAYIDX19_I_EPILOGUE]], align 1, !tbaa [[TBAA23]], !noalias [[META14]]
...
; DRCHECK-NEXT:    br i1 [[EXITCOND_NOT_I_EPILOGUE]], label [[FOR_COND_CLEANUP12_I_LOOPEXIT_EPILOGUE:%.*]], label [[FOR_BODY13_I_EPILOGUE]], !llvm.loop [[LOOP27]]
...
; DRCHECK:       for.cond.cleanup12.i.divergent.entry.epilogue:
...
; DRCHECK-NEXT:    br label [[IF_END33_I_DIVERGENT_EXIT_EPILOGUE]]
...
; DRCHECK-NEXT:    br i1 [[CMP6_I_EPILOGUE]], label [[OMP_INNER_FOR_BODY_I_EPILOGUE]], label [[OMP_LOOP_EXIT_I_LOOPEXIT]], !llvm.loop [[LOOP32:![0-9]+]]
...
; DRCHECK-NEXT:    br label [[FOR_COND_CLEANUP12_I_DIVERGENT_ENTRY_EPILOGUE:%.*]]
; DRCHECK:       if.end33.i.divergent.exit.epilogue:
...
; CHECK-NEXT:    [[DOTOMP_STRIDE_ASCAST_I:%.*]] = addrspacecast ptr addrspace(5) [[DOTOMP_STRIDE_I]] to ptr
; CHECK-NEXT:    [[DOTOMP_IS_LAST_ASCAST_I:%.*]] = addrspacecast ptr addrspace(5) [[DOTOMP_IS_LAST_I]] to ptr
; CHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) [[DOTOMP_LB_I]]) #[[ATTR7]], !noalias [[META33]]
; CHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) [[DOTOMP_UB_I]]) #[[ATTR7]], !noalias [[META33]]
; CHECK-NEXT:    [[CONV_I:%.*]] = trunc i64 [[DOTPREVIOUS_LB_]] to i32
; CHECK-NEXT:    [[CONV2_I:%.*]] = trunc i64 [[DOTPREVIOUS_UB_]] to i32
; CHECK-NEXT:    store i32 [[CONV_I]], ptr addrspace(5) [[DOTOMP_LB_I]], align 4, !tbaa [[TBAA17]], !noalias [[META33]]
; CHECK-NEXT:    store i32 [[CONV2_I]], ptr addrspace(5) [[DOTOMP_UB_I]], align 4, !tbaa [[TBAA17]], !noalias [[META33]]
; CHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) [[DOTOMP_STRIDE_I]]) #[[ATTR7]], !noalias [[META33]]
; CHECK-NEXT:    store i32 1, ptr addrspace(5) [[DOTOMP_STRIDE_I]], align 4, !tbaa [[TBAA17]], !noalias [[META33]]
; CHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) [[DOTOMP_IS_LAST_I]]) #[[ATTR7]], !noalias [[META33]]
; CHECK-NEXT:    store i32 0, ptr addrspace(5) [[DOTOMP_IS_LAST_I]], align 4, !tbaa [[TBAA17]], !noalias [[META33]]
; CHECK-NEXT:    call void @__kmpc_for_static_init_4(ptr addrspacecast (ptr addrspace(1) @[[GLOB12:[0-9]+]] to ptr), i32 [[DOTGLOBAL_TID__VAL]], i32 33, ptr nocapture nonnull [[DOTOMP_IS_LAST_ASCAST_I]], ptr nocapture nonnull [[DOTOMP_LB_ASCAST_I]], ptr nocapture nonnull [[DOTOMP_UB_ASCAST_I]], ptr nocapture nonnull [[DOTOMP_STRIDE_ASCAST_I]], i32 1, i32 1) #[[ATTR1]], !noalias [[META33]]
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr addrspace(5) [[DOTOMP_LB_I]], align 4, !tbaa [[TBAA17]], !noalias [[META33]]
...
; CHECK:       omp.inner.for.body.lr.ph.i:
; CHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr addrspace(5) [[DOTOMP_STRIDE_I]], align 4, !tbaa [[TBAA17]], !noalias [[META33]]
...
; CHECK-NEXT:    store i8 0, ptr addrspace(1) [[ARRAYIDX_I]], align 1, !tbaa [[TBAA21]], !alias.scope [[META33]]
...
; CHECK-NEXT:    tail call void @__kmpc_distribute_static_fini(ptr addrspacecast (ptr addrspace(1) @[[GLOB14:[0-9]+]] to ptr), i32 [[DOTGLOBAL_TID__VAL]]) #[[ATTR1]], !noalias [[META33]]
; CHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) [[DOTOMP_IS_LAST_I]]) #[[ATTR1]], !noalias [[META33]]
; CHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) [[DOTOMP_STRIDE_I]]) #[[ATTR1]], !noalias [[META33]]
; CHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) [[DOTOMP_UB_I]]) #[[ATTR1]], !noalias [[META33]]
; CHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) [[DOTOMP_LB_I]]) #[[ATTR1]], !noalias [[META33]]
; CHECK-NEXT:    ret void
;
...
; DRCHECK-NEXT:    tail call void @llvm.experimental.noalias.scope.decl(metadata [[META33:![0-9]+]])
; DRCHECK-NEXT:    [[DOTOMP_LB_ASCAST_I:%.*]] = addrspacecast ptr addrspace(5) [[DOTOMP_LB_I]] to ptr
; DRCHECK-NEXT:    [[DOTOMP_UB_ASCAST_I:%.*]] = addrspacecast ptr addrspace(5) [[DOTOMP_UB_I]] to ptr
; DRCHECK-NEXT:    [[DOTOMP_STRIDE_ASCAST_I:%.*]] = addrspacecast ptr addrspace(5) [[DOTOMP_STRIDE_I]] to ptr
; DRCHECK-NEXT:    [[DOTOMP_IS_LAST_ASCAST_I:%.*]] = addrspacecast ptr addrspace(5) [[DOTOMP_IS_LAST_I]] to ptr
; DRCHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) [[DOTOMP_LB_I]]) #[[ATTR7]], !noalias [[META33]]
; DRCHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) [[DOTOMP_UB_I]]) #[[ATTR7]], !noalias [[META33]]
; DRCHECK-NEXT:    [[CONV_I:%.*]] = trunc i64 [[DOTPREVIOUS_LB_]] to i32
; DRCHECK-NEXT:    [[CONV2_I:%.*]] = trunc i64 [[DOTPREVIOUS_UB_]] to i32
; DRCHECK-NEXT:    store i32 [[CONV_I]], ptr addrspace(5) [[DOTOMP_LB_I]], align 4, !tbaa [[TBAA17]], !noalias [[META33]]
; DRCHECK-NEXT:    store i32 [[CONV2_I]], ptr addrspace(5) [[DOTOMP_UB_I]], align 4, !tbaa [[TBAA17]], !noalias [[META33]]
; DRCHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) [[DOTOMP_STRIDE_I]]) #[[ATTR7]], !noalias [[META33]]
; DRCHECK-NEXT:    store i32 1, ptr addrspace(5) [[DOTOMP_STRIDE_I]], align 4, !tbaa [[TBAA17]], !noalias [[META33]]
; DRCHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) [[DOTOMP_IS_LAST_I]]) #[[ATTR7]], !noalias [[META33]]
; DRCHECK-NEXT:    store i32 0, ptr addrspace(5) [[DOTOMP_IS_LAST_I]], align 4, !tbaa [[TBAA17]], !noalias [[META33]]
; DRCHECK-NEXT:    call void @__kmpc_for_static_init_4(ptr addrspacecast (ptr addrspace(1) @[[GLOB12:[0-9]+]] to ptr), i32 [[DOTGLOBAL_TID__VAL]], i32 33, ptr nocapture nonnull [[DOTOMP_IS_LAST_ASCAST_I]], ptr nocapture nonnull [[DOTOMP_LB_ASCAST_I]], ptr nocapture nonnull [[DOTOMP_UB_ASCAST_I]], ptr nocapture nonnull [[DOTOMP_STRIDE_ASCAST_I]], i32 1, i32 1) #[[ATTR1]], !noalias [[META33]]
; DRCHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr addrspace(5) [[DOTOMP_LB_I]], align 4, !tbaa [[TBAA17]], !noalias [[META33]]
...
; DRCHECK:       omp.inner.for.body.lr.ph.i:
; DRCHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr addrspace(5) [[DOTOMP_STRIDE_I]], align 4, !tbaa [[TBAA17]], !noalias [[META33]]
...
; DRCHECK-NEXT:    store i8 0, ptr addrspace(1) [[ARRAYIDX_I]], align 1, !tbaa [[TBAA23]], !alias.scope [[META33]]
...
; DRCHECK-NEXT:    tail call void @__kmpc_distribute_static_fini(ptr addrspacecast (ptr addrspace(1) @[[GLOB14:[0-9]+]] to ptr), i32 [[DOTGLOBAL_TID__VAL]]) #[[ATTR1]], !noalias [[META33]]
; DRCHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) [[DOTOMP_IS_LAST_I]]) #[[ATTR1]], !noalias [[META33]]
; DRCHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) [[DOTOMP_STRIDE_I]]) #[[ATTR1]], !noalias [[META33]]
; DRCHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) [[DOTOMP_UB_I]]) #[[ATTR1]], !noalias [[META33]]
; DRCHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) [[DOTOMP_LB_I]]) #[[ATTR1]], !noalias [[META33]]
; DRCHECK-NEXT:    ret void
;
entry:
  %.omp.lb.i = alloca i32, align 4, addrspace(5)
...
; CHECK-NEXT:    [[TMP0:%.*]] = tail call i32 @__kmpc_target_init(ptr addrspacecast (ptr addrspace(1) @__omp_offloading_58_208beb0_main_l83_kernel_environment to ptr)) #[[ATTR1]], !noalias [[META36:![0-9]+]]
...
; CHECK-NEXT:    [[TMP1:%.*]] = tail call i32 @__kmpc_global_thread_num(ptr addrspacecast (ptr addrspace(1) @[[GLOB15:[0-9]+]] to ptr)) #[[ATTR1]], !noalias [[META36]]
; CHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 32, ptr addrspace(5) [[CAPTURED_VARS_ADDRS_I_I_I]]), !noalias [[META36]]
...
; CHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) [[DOTOMP_COMB_LB_I_I_I]]) #[[ATTR7]], !noalias [[META39:![0-9]+]]
; CHECK-NEXT:    store i32 0, ptr addrspace(5) [[DOTOMP_COMB_LB_I_I_I]], align 4, !tbaa [[TBAA17]], !noalias [[META39]]
; CHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) [[DOTOMP_COMB_UB_I_I_I]]) #[[ATTR7]], !noalias [[META39]]
; CHECK-NEXT:    store i32 1023, ptr addrspace(5) [[DOTOMP_COMB_UB_I_I_I]], align 4, !tbaa [[TBAA17]], !noalias [[META39]]
; CHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) [[DOTOMP_STRIDE_I_I_I]]) #[[ATTR7]], !noalias [[META39]]
; CHECK-NEXT:    store i32 1, ptr addrspace(5) [[DOTOMP_STRIDE_I_I_I]], align 4, !tbaa [[TBAA17]], !noalias [[META39]]
; CHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) [[DOTOMP_IS_LAST_I_I_I]]) #[[ATTR7]], !noalias [[META39]]
; CHECK-NEXT:    store i32 0, ptr addrspace(5) [[DOTOMP_IS_LAST_I_I_I]], align 4, !tbaa [[TBAA17]], !noalias [[META39]]
; CHECK-NEXT:    [[NVPTX_NUM_THREADS_I_I_I:%.*]] = tail call i32 @__kmpc_get_hardware_num_threads_in_block() #[[ATTR1]], !noalias [[META39]]
; CHECK-NEXT:    call void @__kmpc_distribute_static_init_4(ptr addrspacecast (ptr addrspace(1) @[[GLOB11:[0-9]+]] to ptr), i32 [[TMP1]], i32 91, ptr nocapture nonnull [[DOTOMP_IS_LAST_ASCAST_I_I_I]], ptr nocapture nonnull [[DOTOMP_COMB_LB_ASCAST_I_I_I]], ptr nocapture nonnull [[DOTOMP_COMB_UB_ASCAST_I_I_I]], ptr nocapture nonnull [[DOTOMP_STRIDE_ASCAST_I_I_I]], i32 1, i32 [[NVPTX_NUM_THREADS_I_I_I]]) #[[ATTR1]], !noalias [[META39]]
; CHECK-NEXT:    [[DOTOMP_COMB_LB_PROMOTED_I_I_I:%.*]] = load i32, ptr addrspace(5) [[DOTOMP_COMB_LB_I_I_I]], align 4, !noalias [[META39]]
...
; CHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr addrspace(5) [[DOTOMP_COMB_UB_I_I_I]], align 4, !noalias [[META39]]
...
; CHECK-NEXT:    [[TMP7:%.*]] = load i32, ptr addrspace(5) [[DOTOMP_STRIDE_I_I_I]], align 4, !noalias [[META39]]
...
; CHECK-NEXT:    store ptr [[TMP10]], ptr addrspace(5) [[CAPTURED_VARS_ADDRS_I_I_I]], align 8, !tbaa [[TBAA44:![0-9]+]], !noalias [[META39]]
; CHECK-NEXT:    [[TMP11:%.*]] = inttoptr i64 [[TMP9]] to ptr
; CHECK-NEXT:    store ptr [[TMP11]], ptr addrspace(5) [[TMP3]], align 8, !tbaa [[TBAA44]], !noalias [[META39]]
; CHECK-NEXT:    store ptr [[D_BATCH_RESULT]], ptr addrspace(5) [[TMP4]], align 8, !tbaa [[TBAA44]], !noalias [[META39]]
; CHECK-NEXT:    store ptr [[TMP6]], ptr addrspace(5) [[TMP5]], align 8, !tbaa [[TBAA44]], !noalias [[META39]]
; CHECK-NEXT:    call void @__kmpc_parallel_51(ptr addrspacecast (ptr addrspace(1) @[[GLOB15]] to ptr), i32 [[TMP1]], i32 1, i32 -1, i32 -1, ptr nonnull @__omp_offloading_58_208beb0_main_l83_debug___omp_outlined_debug___omp_outlined, ptr null, ptr nonnull [[CAPTURED_VARS_ADDRS_ASCAST_I_I_I]], i64 4) #[[ATTR1]], !noalias [[META46:![0-9]+]]
...
; CHECK-NEXT:    call void @__kmpc_distribute_static_fini(ptr addrspacecast (ptr addrspace(1) @[[GLOB14]] to ptr), i32 [[TMP1]]) #[[ATTR1]], !noalias [[META46]]
; CHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) [[DOTOMP_IS_LAST_I_I_I]]) #[[ATTR1]], !noalias [[META39]]
; CHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) [[DOTOMP_STRIDE_I_I_I]]) #[[ATTR1]], !noalias [[META39]]
; CHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) [[DOTOMP_COMB_UB_I_I_I]]) #[[ATTR1]], !noalias [[META39]]
; CHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) [[DOTOMP_COMB_LB_I_I_I]]) #[[ATTR1]], !noalias [[META39]]
; CHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 32, ptr addrspace(5) [[CAPTURED_VARS_ADDRS_I_I_I]]), !noalias [[META36]]
...
; DRCHECK-NEXT:    [[TMP0:%.*]] = tail call i32 @__kmpc_target_init(ptr addrspacecast (ptr addrspace(1) @__omp_offloading_58_208beb0_main_l83_kernel_environment to ptr)) #[[ATTR1]], !noalias [[META36:![0-9]+]]
...
; DRCHECK-NEXT:    [[TMP1:%.*]] = tail call i32 @__kmpc_global_thread_num(ptr addrspacecast (ptr addrspace(1) @[[GLOB15:[0-9]+]] to ptr)) #[[ATTR1]], !noalias [[META36]]
; DRCHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 32, ptr addrspace(5) [[CAPTURED_VARS_ADDRS_I_I_I]]), !noalias [[META36]]
...
; DRCHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) [[DOTOMP_COMB_LB_I_I_I]]) #[[ATTR7]], !noalias [[META39:![0-9]+]]
; DRCHECK-NEXT:    store i32 0, ptr addrspace(5) [[DOTOMP_COMB_LB_I_I_I]], align 4, !tbaa [[TBAA17]], !noalias [[META39]]
; DRCHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) [[DOTOMP_COMB_UB_I_I_I]]) #[[ATTR7]], !noalias [[META39]]
; DRCHECK-NEXT:    store i32 1023, ptr addrspace(5) [[DOTOMP_COMB_UB_I_I_I]], align 4, !tbaa [[TBAA17]], !noalias [[META39]]
; DRCHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) [[DOTOMP_STRIDE_I_I_I]]) #[[ATTR7]], !noalias [[META39]]
; DRCHECK-NEXT:    store i32 1, ptr addrspace(5) [[DOTOMP_STRIDE_I_I_I]], align 4, !tbaa [[TBAA17]], !noalias [[META39]]
; DRCHECK-NEXT:    call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) [[DOTOMP_IS_LAST_I_I_I]]) #[[ATTR7]], !noalias [[META39]]
; DRCHECK-NEXT:    store i32 0, ptr addrspace(5) [[DOTOMP_IS_LAST_I_I_I]], align 4, !tbaa [[TBAA17]], !noalias [[META39]]
; DRCHECK-NEXT:    [[NVPTX_NUM_THREADS_I_I_I:%.*]] = tail call i32 @__kmpc_get_hardware_num_threads_in_block() #[[ATTR1]], !noalias [[META39]]
; DRCHECK-NEXT:    call void @__kmpc_distribute_static_init_4(ptr addrspacecast (ptr addrspace(1) @[[GLOB11:[0-9]+]] to ptr), i32 [[TMP1]], i32 91, ptr nocapture nonnull [[DOTOMP_IS_LAST_ASCAST_I_I_I]], ptr nocapture nonnull [[DOTOMP_COMB_LB_ASCAST_I_I_I]], ptr nocapture nonnull [[DOTOMP_COMB_UB_ASCAST_I_I_I]], ptr nocapture nonnull [[DOTOMP_STRIDE_ASCAST_I_I_I]], i32 1, i32 [[NVPTX_NUM_THREADS_I_I_I]]) #[[ATTR1]], !noalias [[META39]]
; DRCHECK-NEXT:    [[DOTOMP_COMB_LB_PROMOTED_I_I_I:%.*]] = load i32, ptr addrspace(5) [[DOTOMP_COMB_LB_I_I_I]], align 4, !noalias [[META39]]
...
; DRCHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr addrspace(5) [[DOTOMP_COMB_UB_I_I_I]], align 4, !noalias [[META39]]
...
; DRCHECK-NEXT:    [[TMP7:%.*]] = load i32, ptr addrspace(5) [[DOTOMP_STRIDE_I_I_I]], align 4, !noalias [[META39]]
...
; DRCHECK-NEXT:    store ptr [[TMP10]], ptr addrspace(5) [[CAPTURED_VARS_ADDRS_I_I_I]], align 8, !tbaa [[TBAA44:![0-9]+]], !noalias [[META39]]
; DRCHECK-NEXT:    [[TMP11:%.*]] = inttoptr i64 [[TMP9]] to ptr
; DRCHECK-NEXT:    store ptr [[TMP11]], ptr addrspace(5) [[TMP3]], align 8, !tbaa [[TBAA44]], !noalias [[META39]]
; DRCHECK-NEXT:    store ptr [[D_BATCH_RESULT]], ptr addrspace(5) [[TMP4]], align 8, !tbaa [[TBAA44]], !noalias [[META39]]
; DRCHECK-NEXT:    store ptr [[TMP6]], ptr addrspace(5) [[TMP5]], align 8, !tbaa [[TBAA44]], !noalias [[META39]]
; DRCHECK-NEXT:    call void @__kmpc_parallel_51(ptr addrspacecast (ptr addrspace(1) @[[GLOB15]] to ptr), i32 [[TMP1]], i32 1, i32 -1, i32 -1, ptr nonnull @__omp_offloading_58_208beb0_main_l83_debug___omp_outlined_debug___omp_outlined, ptr null, ptr nonnull [[CAPTURED_VARS_ADDRS_ASCAST_I_I_I]], i64 4) #[[ATTR1]], !noalias [[META46:![0-9]+]]
...
; DRCHECK-NEXT:    call void @__kmpc_distribute_static_fini(ptr addrspacecast (ptr addrspace(1) @[[GLOB14]] to ptr), i32 [[TMP1]]) #[[ATTR1]], !noalias [[META46]]
; DRCHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) [[DOTOMP_IS_LAST_I_I_I]]) #[[ATTR1]], !noalias [[META39]]
; DRCHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) [[DOTOMP_STRIDE_I_I_I]]) #[[ATTR1]], !noalias [[META39]]
; DRCHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) [[DOTOMP_COMB_UB_I_I_I]]) #[[ATTR1]], !noalias [[META39]]
; DRCHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) [[DOTOMP_COMB_LB_I_I_I]]) #[[ATTR1]], !noalias [[META39]]
; DRCHECK-NEXT:    call void @llvm.lifetime.end.p5(i64 32, ptr addrspace(5) [[CAPTURED_VARS_ADDRS_I_I_I]]), !noalias [[META36]]
