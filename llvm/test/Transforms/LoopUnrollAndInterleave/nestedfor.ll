...
; CHECK-NEXT:    br i1 [[CALL_EPILOGUE]], label [[FOR_BODY_EPILOGUE:%.*]], label [[OMP_INNER_FOR_INC_EPILOGUE]]
...
; DRCHECK-NEXT:    br i1 [[CALL_EPILOGUE]], label [[FOR_BODY_EPILOGUE:%.*]], label [[OMP_INNER_FOR_INC_EPILOGUE]]
